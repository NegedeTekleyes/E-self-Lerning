        ...
        <div className="container mx-auto p-4">
            <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* FIX: Add relative positioning and size to the parent div */}
                    <div className="md:order-2 relative w-full h-64 rounded-lg overflow-hidden">
                        ...
                        <Image
                            ...
                            style={{ objectFit: 'cover' }} // Replicates the object-cover behavior
                            sizes="(max-width: 768px) 100vw, 50vw" // Optimizes image loading based on viewport size
                        />
                    </div>
