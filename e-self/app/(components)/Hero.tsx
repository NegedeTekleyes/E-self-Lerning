...
export default function Hero() {
  return (
    <div className="relative bg-[#EEEEEE] overflow-hidden">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                ...
                <span className="block text-[#8E1616] xl:inline">online business</span>
              </h1>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 h-[600px]"> {/* Added height here */}
        <Image
          className="h-full w-full object-cover" // Adjusted height here
          src="/hero-image.jpg"
          alt=""
          width={500}
          height={600} // Adjusted height here
